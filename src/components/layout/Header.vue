  ...
  <div class="header">
    ...
    <div v-if="top" style="margin:auto;border:1px solid red;text-align:center;">
      <el-menu
        ...
        router
        :default-active="'/'"
        style="width:80%;margin:auto;border:1px solid red;"
      >
        <el-menu-item>
          <el-link
            type="primary"
            href="/"
            :underline="false"
            style="font-size:30px;color:#0084FF"
            >知乎</el-link
          >
        </el-menu-item>
        ...
        <el-menu-item>
          <el-input placeholder="内容" @focus="showHotSearch()">
            <i class="search" />
          </el-input>
          <el-button type="primary" @click="popQuestionCard()">提问</el-button>
