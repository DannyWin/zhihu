            ...
            <div class="questionHeader-content">
                <div class="questionHeader-main">
                    ...
                    <div class="questionHeader-action">
                        <QuestionToolBar :voteCount="this.data.voteCount" @changeVoteCount="changeVoteCount" :commentCount="this.data.comment.length" @expandComment="expandComment"></QuestionToolBar>
                    </div>
                </div>
            ...
            <div class="questionContent-main">
                ...
                <div class="allAnswer">
                    ...
                    <el-row class="allAnswerContent">
                        <Answer v-for="(answer) in question.answers" :key="answer.id" :answer="answer" :user="user"></Answer>
                    </el-row>
                </div>
            </div>
